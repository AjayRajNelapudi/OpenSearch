 ...
 *
 * <p>For any string that is not one of the 7 valid stat section names, when included
...
public class InvalidStatNameRejectionPropertyTests {
     ...
     *
     * <p>For any string not in the 7 valid stat section names, the REST handler
