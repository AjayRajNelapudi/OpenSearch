...
//!
//! This avoids the delta-based `tokio_metrics::RuntimeIntervals` approach
//! which proved unreliable when called from non-tokio threads (JNI).

use tokio::runtime::Handle;

/// Snapshot of runtime metrics read directly from the tokio Handle.
///
...
pub struct MetricsSnapshot {
    ...
    pub max_busy_duration_ms: u64,
    pub min_busy_duration_ms: u64,
...
impl MetricsCollector {
    ...
    pub fn snapshot(&self) -> MetricsSnapshot {
        ...
        MetricsSnapshot {
            ...
            total_local_queue_depth: total_local_depth,
            max_local_queue_depth: max_local_depth,
            min_local_queue_depth: min_local_depth,
