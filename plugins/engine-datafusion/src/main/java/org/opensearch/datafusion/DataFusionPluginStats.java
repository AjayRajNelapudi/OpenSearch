...
public class DataFusionPluginStats implements PluginStats {
    ...
    public static final String NAME = "datafusion";
     ...
     * Read from a stream.
     */
    public DataFusionPluginStats(StreamInput in) throws IOException {
        this.ioRuntime = in.readOptionalWriteable(RuntimeValues::new);
        this.cpuRuntime = in.readOptionalWriteable(RuntimeValues::new);
        this.queryExecution = new TaskMonitorValues(in);
        this.streamNext = new TaskMonitorValues(in);
        this.fetchPhase = new TaskMonitorValues(in);
        this.segmentStats = new TaskMonitorValues(in);
    }
    ...
    public void writeTo(StreamOutput out) throws IOException {
        ...
        out.writeOptionalWriteable(cpuRuntime);
        queryExecution.writeTo(out);
        streamNext.writeTo(out);
        fetchPhase.writeTo(out);
        segmentStats.writeTo(out);
    }
    ...
    public XContentBuilder toXContent(XContentBuilder builder, Params params) throws IOException {
        ...
        queryExecution.toXContent(builder);
        builder.endObject();

        builder.startObject(STREAM_NEXT);
        streamNext.toXContent(builder);
        builder.endObject();

        builder.startObject(FETCH_PHASE);
        fetchPhase.toXContent(builder);
        builder.endObject();

        builder.startObject(SEGMENT_STATS);
        segmentStats.toXContent(builder);
        builder.endObject();
    ...
    public static class RuntimeValues implements Writeable {
         ...
         */
        static RuntimeValues fromProto(DataFusionStatsProto.RuntimeMetrics rm) {
    ...
    public static class TaskMonitorValues implements Writeable {
         ...
         */
        static TaskMonitorValues fromProto(DataFusionStatsProto.TaskMonitorMetrics tm) {
