...
public class NodeService implements Closeable {
    ...
    @Nullable
    private final ServiceCache<PluginStats> dataFusionService;
    ...
    public NodeStats stats(
        ...
        PluginStats dataFusionPluginStats = (nativeMetrics && dataFusionService != null) ? dataFusionService.getOrRefresh() : null;
